...
export const Route = createFileRoute("/book")({
  head: () => ({
    meta: [
      { title: "Book an Appointment — J Salon Unisex" },
      {
        name: "description",
        content:
          "Request your appointment at J Salon Unisex Anantapur in under a minute. Or call us directly at 079012 36700.",
      },
      { property: "og:title", content: "Book — J Salon Unisex" },
      {
        property: "og:description",
        content: "Request your salon appointment online — we'll call to confirm.",
      },
    ...
    <>
            ...
            {[
              {
                ...
                desc: "Fill the form with your preferred date, time and service.",
              },
              {
                icon: PhoneCall,
                step: "02",
                title: "We Call to Confirm",
                desc: "Our team gets in touch within a few hours to lock in your slot.",
              },
              {
                icon: Sparkles,
                step: "03",
                title: "Come In & Transform",
                desc: "Walk in on the day — sit back, relax and let us do the rest.",
              },
            ].map((s, i) => (
              <Reveal key={s.step} delay={i * 0.1}>
                <div className="relative bg-black-deep border border-gold/20 rounded-sm p-7 h-full hover:border-gold/50 transition-colors">
                  <span className="absolute top-4 right-5 font-display text-5xl text-gold/15">
                    {s.step}
                  </span>
      ...
      <section className="py-20 px-6">
        <Reveal className="max-w-2xl mx-auto text-center">
          <p className="font-accent text-xs text-gold tracking-widest uppercase">
            Prefer to talk?
          </p>
