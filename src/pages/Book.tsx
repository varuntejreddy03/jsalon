    ...
    <>
      ...
      <section className="bg-cream py-20 px-6 border-y border-hairline-strong">
        <div className="max-w-5xl mx-auto">
          <Reveal className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl text-ink">What Happens Next</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={s.step} delay={i * 0.1}>
                <div className="relative bg-white border border-hairline-strong rounded-sm p-7 h-full hover:border-gold/50 transition-colors">
      ...
      <section className="py-20 px-6">
        <Reveal className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="mt-3 font-display text-4xl md:text-5xl text-ink">Call Us Directly</h2>
          <a
            href={PHONE_HREF}
            className="mt-8 inline-flex items-center gap-3 rounded-sm bg-gold px-8 py-4 text-xl font-medium text-black-deep hover:bg-gold-light transition-all shadow-soft hover:scale-105"
          >
            <Phone className="h-5 w-5" /> {PHONE}
          </a>
          <div className="mt-10 inline-flex items-center gap-3 bg-cream border border-hairline-strong rounded-sm px-5 py-3 text-sm">
